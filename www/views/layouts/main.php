    ...
    <div class="container">
      <a href="<?=Url::home();?>" class="navbar-brand">
        <img src="/template/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">
        <span class="brand-text font-weight-light"><?=Yii::t('app', 'Платежной системы');?></span>
      </a>
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">        
        <li class="nav-item">
         <a href="<?=Url::to(['/admin']);?>" class="btn btn-block btn-outline-success btn-sm">
           <?=Yii::t('app', 'Воити');?>
         </a>
        </li>
      </ul>
